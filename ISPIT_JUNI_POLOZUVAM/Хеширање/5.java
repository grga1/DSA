    ...
    public static void main(String[] args) {
       ...
       int n = scanner.nextInt();
        ...
        for (int i = 0; i < m; i++) {
            ...
            System.out.println(mapa.get(ip).Ime+" "+mapa.get(ip).Prezime+" with salary "+mapa.get(ip).Budget+" from address "+mapa.get(ip).Ip_adresa+" who spent "+mapa.get(ip).Cena);
            System.out.println();
        }
    }
}
